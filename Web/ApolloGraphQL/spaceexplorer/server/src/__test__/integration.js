...
describe('Queries', () => {
  it('fetches list of launches', async () => {
    // * create an instance of ApolloServer that mocks out the context, while reusing
    ...
    const { query } = createTestClinet(server);
...
describe('Mutations', () => {
  ...
  it('books trips', async () => {
    ...
    userAPI.store.strips.findAll.mockReturnValueOnce([{}]);
